...
class NetworkManager {
    ...
    static func addMessageToAssignment(classId: Int, assignmentId: Int, message: String, username: String, name: String, time: String, completion: @escaping (Message) -> Void) {
